...
- `CREATE`: `9` requirements
- `LINK`: `19` requirements
- `NOT_IN_ISSUE_PLANNING`: `38` requirements
- `NO_CHANGE`: `3` requirements

## Findings

- `warning` `github_action_gate_possible_existing_issue_match` req=`-` issuePlan=`IPLAN-013` action=`GHACT-013`: Moegliches vorhandenes GitHub-Issue #11 (open, score 4): Klaerung: Uebernahme aus Akten und Drittsystemen entscheiden
- `warning` `github_action_gate_possible_existing_issue_match` req=`-` issuePlan=`IPLAN-016` action=`GHACT-016`: Moegliches vorhandenes GitHub-Issue #26 (open, score 4): Team-Setup für Flutter/Dart mit abgestimmten Tool-Versionen und Android-11-Startziel dokumentieren
