...
- Input messages: `29`
- Roles: `assistant=12`, `tool=12`, `user=5`
- Transcript visible: `yes`
- Context artifact visible: `yes`
- Tool results visible: `yes`
- Visible tool result messages: `12`
- Total inspectable chars: `108176`
...
| 15 | assistant | FunctionCallContent, TextContent | 114 | yes | no | no | no | `docs/requirements.md` |
| 16 | tool | FunctionResultContent | 12620 | no | yes | yes | yes | `input/transcripts/T9999_chaos.txt`<br>`runs/phase2_1/20260529_94e0e8/state/context.md` |
| 17 | assistant | FunctionCallContent, TextContent | 147 | yes | no | no | yes | `runs/phase2_1/20260529_124611_94e0e8/state/context.md` |
| 18 | tool | FunctionResultContent | 6738 | no | yes | no | yes | - |
| 19 | user | ChatMessage | 0 | no | no | no | no | - |
| 20 | assistant | FunctionCallContent, TextContent | 114 | yes | no | no | no | `docs/requirements.md` |
| 21 | tool | FunctionResultContent | 12620 | no | yes | yes | yes | `input/transcripts/T9999_chaos.txt`<br>`runs/phase2_1/20260529_94e0e8/state/context.md` |
| 22 | assistant | FunctionCallContent, TextContent | 99 | yes | no | no | no | - |
| 23 | tool | FunctionResultContent | 101 | no | yes | no | no | `docs/requirements.md` |
| 24 | assistant | FunctionCallContent, TextContent | 14690 | yes | no | yes | yes | `docs/architecture.md`<br>`docs/requirements.md`<br>`input/transcripts/T9999_chaos.txt`<br>`runs/phase2_1/20260529_94e0e8/state/context.md` |
| 25 | tool | FunctionResultContent | 91 | no | yes | no | no | - |
| 26 | assistant | FunctionCallContent, TextContent | 114 | yes | no | no | no | `docs/architecture.md` |
| 27 | tool | FunctionResultContent | 11869 | no | yes | yes | yes | `docs/requirements.md`<br>`input/transcripts/T9999_chaos.txt`<br>`runs/phase2_1/20260529_94e0e8/state/context.md` |
| 28 | user | TextContent | 191 | no | no | no | no | `docs/architecture.md` |
