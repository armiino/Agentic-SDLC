...
- Requirements with delivery coverage: `17`
- Requirements with clarification coverage: `36`
- Requirements without operational coverage: `2`
- Blocked requirements: `0`
- NO_CHANGE-only requirements: `14`
...
- `warning` `missing_operational_coverage` req=`CAN-REQ-041` issuePlan=`-` action=`-`: Requirement hat weder Delivery- noch Klaerungsabdeckung im aktuellen Operationalisierungsstand.
- `warning` `missing_operational_coverage` req=`CAN-REQ-042` issuePlan=`-` action=`-`: Requirement hat weder Delivery- noch Klaerungsabdeckung im aktuellen Operationalisierungsstand.
...
- `info` `no_change_only` req=`CAN-REQ-016` issuePlan=`IPLAN-002` action=`GHACT-002`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
- `info` `no_change_only` req=`CAN-REQ-043` issuePlan=`IPLAN-012` action=`GHACT-012`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
- `info` `no_change_only` req=`CAN-REQ-044` issuePlan=`IPLAN-008` action=`GHACT-008`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
- `info` `no_change_only` req=`CAN-REQ-045` issuePlan=`IPLAN-008` action=`GHACT-008`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
- `info` `no_change_only` req=`CAN-REQ-046` issuePlan=`IPLAN-008` action=`GHACT-008`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
...
- `info` `no_change_only` req=`CAN-REQ-048` issuePlan=`IPLAN-008` action=`GHACT-008`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
- `info` `no_change_only` req=`CAN-REQ-049` issuePlan=`IPLAN-008` action=`GHACT-008`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
...
- `info` `no_change_only` req=`CAN-REQ-056` issuePlan=`IPLAN-017` action=`GHACT-017`: Requirement ist bewusst ohne GitHub-Write operationalisiert.
...
- `CAN-REQ-041` Optionale Hilfe- oder Tutorial-Funktion vorsehen
  ...
  - operationalizationStatus: `missing_operational_coverage`
  - issuePlanIds: ``
  - clarificationPlanIds: ``
  - githubActions: ``
  - operations: ``
  - findings: `missing_operational_coverage`
