ARTEFAKT: Produktvision (art=vision, Ziel-Datei docs/vision.md)
...
ARCH-11 [architecture, Rollen: constraint+design] Mitarbeiter dürfen nicht einrichtungsübergreifend auf alle Profile zugreifen, sondern nur auf Profile der Einrichtung, in der sie tätig sind; die technische Ums…
...
PBI-003 [pbi, Zugang und Rechteverwaltung] Rechtemodell für Einrichtungs-Personal, Angehörige und Leitung festlegen
...
PBI-032 [pbi, Dokumentationsintegration und Erweiterungen] Es soll eine Übergabe-Notiz pro Schicht geben, die der nächsten Schicht beim Öffnen der Ap...
...
PBI-046 [pbi, Besuchsankündigung und Besuchskoordination] Besuche bei der Bezugsperson mit Datum und Uhrzeit vorab ankündigen
