...
| 2 | tool | StewardAgent | - | ja | 6252 |
| 3 | assistant | StewardAgent | - | - | 3264 |
| 4 | user | - | - | - | 98 |
...
| 6 | tool | StewardAgent | - | ja | 575 |
| 7 | assistant | StewardAgent | - | - | 2106 |
| 8 | user | - | - | - | 138 |
...
|-------|-----------|------|------|
| #1 | StewardAgent | `get_core_item` | - |
| #5 | StewardAgent | `search_github_issues` | - |
...
| 9 | assistant | StewardAgent | - | - | 2340 |
| 10 | user | - | - | - | 84 |
| 11 | assistant | StewardAgent | - | - | 3086 |
| 12 | user | - | - | - | 208 |
