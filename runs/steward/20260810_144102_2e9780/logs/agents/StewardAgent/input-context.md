...
| 4 | tool | StewardAgent | - | ja | 698 |
| 5 | assistant | StewardAgent | ja | - | 0 |
| 6 | tool | StewardAgent | - | ja | 36 |
| 7 | assistant | StewardAgent | - | - | 2030 |
| 8 | user | - | - | - | 100 |
...
|-------|-----------|------|------|
| #3 | StewardAgent | `get_core_overview` | - |
