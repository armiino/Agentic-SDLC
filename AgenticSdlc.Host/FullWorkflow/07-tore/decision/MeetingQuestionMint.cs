...
public static class MeetingQuestionMint
{
    ...
    /// <summary>Item-Fabrik: EIN DEC-Item aus einer Meeting-Frage (I7: sourceRunId = Ausloeser-Lauf;
    /// Delta-Herkunft via ingestedFrom/ingestedFromRun; Beleg-Kette via claimIds).</summary>
