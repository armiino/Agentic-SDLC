...
public static class GithubCommands
{
    public static void Register(IDictionary<string, AgenticSdlc.Host.CommandHandler> map)
    {
        ...
        map["github-read"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubReadRunner.RunAsync(args, repoRoot);
        ...
        map["github-forward"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardRunner.RunAsync(args, settings, repoRoot);
        ...
        map["github-forward-hitl"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardHitlRunner.RunAsync(args, settings, repoRoot);

        map["github-forward-review"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardReviewRunner.RunAsync(args, settings, repoRoot);
        ...
        map["github-forward-apply"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardApplyRunner.RunAsync(args, repoRoot);
        ...
        map["github-reverse"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubReverseRunner.RunAsync(args, repoRoot);

        map["github-reverse-review"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubReverseReviewRunner.RunAsync(args, settings, repoRoot);

        map["github-reverse-apply"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubReverseApplyRunner.RunAsync(args, repoRoot);
        ...
        map["github-forward-compare"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardCompareRunner.RunAsync(args, repoRoot);
        ...
        map["github-forward-rerun-test"] = (args, settings, repoRoot) => AgenticSdlc.Host.Phases.Phase2.EvidenzAgent.Tor3.GithubForwardRerunTest.RunAsync(args, repoRoot);
    }
}
