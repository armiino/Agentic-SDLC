...
public static class IngestionApplyRunner
{
    ...
    public static async Task<int> RunAsync(string[] args, string repoRoot)
    {
        ...
        var affectedView = IngestionApply.BuildAffectedView(updatedCore, affectedIds);
        ...
        Console.WriteLine($"[ingest-apply] delta: added={d.Added} refined={d.Refined} reaffirmed={d.Reaffirmed} superseded={d.Superseded} contradicted={d.Contradicted}");
