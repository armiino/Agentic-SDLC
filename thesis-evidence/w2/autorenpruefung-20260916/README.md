# Autorenprüfung der Evaluation – 16.09.2026
...
|---|---:|---:|
| 01 · Analyst: 17 Vorschläge | 17 | 102 |
| 02 · Drei PBIs vor und nach der Änderung | 3 | 132 |
| 03 · Zwölf Fortschreibungsfälle | 12 | 96 |
| 04 · Abdeckung der vier Hauptläufe | 280 | 280 |
| 05 · Zwei Ledger-Wiederholungen | 218 | 218 |
| 06 · Claim-Korrektheit und Quellenstützung | 309 | 655 |
| 07 · Stufenanalyse vor der Kanonisierung | 109 | 109 |
| 08 · Lückentypen, Zitate und Sonderzuordnung | 152 | 152 |
| 09 · Historische Fallserie und Prozessbelege | 11 | 11 |
| 10 · Referenzbestand und Quellvollständigkeit | 312 | 312 |
| 11 · Ergänzende Modellreihe (alter Goldstand) | 436 | 436 |
| Gesamt | 1859 | 2503 |
...
- `pruefdaten.json.gz` (komprimierte JSON-Datei): vollständiger, unveränderter Datenstand des Prüfungspakets.
- `antworten-leer.json`: leere Antwortvorlage; niemals als erledigte Prüfung ausgeben.
- `quellenmanifest.json`: Pfade, Größen und SHA-256 der 798 beigelegten Originaldateien.
- `belege.zip`: unveränderte Originalkopien unter den im Manifest bezeichneten `belege/`-Pfaden. Bei Bedarf entpacken; die Oberfläche zeigt sie bereits ohne Entpacken. Die Oberfläche zeigt ihren ursprünglichen Pfad und Inhalt.
