...
- [x] AU-0002 needs_human: Gesprächskontext — kein Gold-Inhalt betroffen (kein Treffer, aber billige Human-Prüfung) — Zuordnung korrekt?
- [x] AU-0008 attach_as_evidence: Gegenrede zu no-gos-pro-bewohner — Gold G-007 ist bereits GEDECKT (kein Miss-Treffer) — Zuordnung korrekt?
- [x] AU-0026 needs_human: Wichtigkeitsbekundung ohne Bezug — kein Gold-Inhalt betroffen — Zuordnung korrekt?
