...
> Verifiziert am 06.09.2026 anhand des Regelkopfs und des vollständigen F-Bestands in Anhang A.
> Nicht bestätigte Urteile bleiben unmarkiert und tragen eine Korrekturanmerkung.
...
### PFLICHT · G-009 [requirement] — mein Urteil: **NONE**
  ...
  Prüffrage: Enthält WIRKLICH keine F-Aussage (auch Anhang A) diesen Inhalt?
  - [ ] Urteil bestätigt   — **eher FULL:** C-008 nennt genau den Sofortinfo-Bereich auf der
    Profil-Detailansicht und fordert für ihn künftig eine Begrenzung auf fünf Einträge. Damit setzt
    die Aussage das Fortbestehen dieses Bereichs zwingend voraus; die zusätzliche Fünfergrenze
    schadet der P1-Deckung nicht.
