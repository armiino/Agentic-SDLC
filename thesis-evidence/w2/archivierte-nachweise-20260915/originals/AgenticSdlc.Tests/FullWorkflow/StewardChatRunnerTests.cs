...
public sealed class StewardChatRunnerTests
{
    ...
    public async Task Huelle_traegt_Tools_und_Session_ueberlebt_den_Datei_Roundtrip()
    {
        ...
        Assert.Contains("36 Tools", first.Text);                             // 28 (⚖ 13.08.) + 1g (4) + Slice S: propose_pbi_fields, draft/save/read_authored_doc
        ...
        Assert.Contains("37 Tools", liveResp.Text);                          // 36 + 1 Live-Tool
