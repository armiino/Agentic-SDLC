...
- **ARCH-01** — Die Loesung bleibt eine digitale App zur Foerderung der Kommunikation zwischen betreuten Menschen und anderen Personen; zusaetzlich wird kon…
...
- **ARCH-15** — Nach dem Login soll eine Profilübersicht mit anklickbarer Liste der sichtbaren Bewohnerprofile angezeigt werden.
  - bindet: PBI-007 (Konsistente Appbar mit Basisnavigation nach dem Lo…) · PBI-009 (Profilübersicht mit Suche und öffnbaren Profilkart…)
